...
WebUI.setText(findTestObject('Object Repository/Page_BOSCOLISTA/input_Tareas_task-input'), 'COMPLETAR MIS HORAS DE TRABAJO')

WebUI.click(findTestObject('Object Repository/Page_BOSCOLISTA/button_Aadir'))

WebUI.click(findTestObject('Object Repository/Page_BOSCOLISTA/p_1 Tasks'))
